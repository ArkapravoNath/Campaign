...
/**
 * REST controller for managing {@link com.gok.campaign.domain.Zone}.
 */
@RestController
@RequestMapping("/api")
public class ZoneResource {
    ...
    private static final String ENTITY_NAME = "campaignZone";
     ...
     */
    @GetMapping("/zones")
    public ResponseEntity<List<ZoneDTO>> getAllZones(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
