...
public class OwnerResourceIT {
    ...
    private static final String DEFAULT_COMMAND_CENTER_NUMBER = "AAAAAAAAAA";
    private static final String UPDATED_COMMAND_CENTER_NUMBER = "BBBBBBBBBB";
    ...
    public static Owner createEntity(EntityManager em) {
        Owner owner = new Owner()
            ...
            .commandCenterNumber(DEFAULT_COMMAND_CENTER_NUMBER)
            .email(DEFAULT_EMAIL)
    ...
    public static Owner createUpdatedEntity(EntityManager em) {
        Owner owner = new Owner()
            ...
            .commandCenterNumber(UPDATED_COMMAND_CENTER_NUMBER)
            .email(UPDATED_EMAIL)
    ...
    public void createOwner() throws Exception {
        ...
        assertThat(testOwner.getCommandCenterNumber()).isEqualTo(DEFAULT_COMMAND_CENTER_NUMBER);
        assertThat(testOwner.getEmail()).isEqualTo(DEFAULT_EMAIL);
        assertThat(testOwner.getMetadata()).isEqualTo(DEFAULT_METADATA);
    }
    ...
    public void getAllOwners() throws Exception {
        ...
        restOwnerMockMvc.perform(get("/api/owners?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].commandCenterNumber").value(hasItem(DEFAULT_COMMAND_CENTER_NUMBER)))
    ...
    public void getOwner() throws Exception {
        ...
        restOwnerMockMvc.perform(get("/api/owners/{id}", owner.getId()))
            ...
            .andExpect(jsonPath("$.commandCenterNumber").value(DEFAULT_COMMAND_CENTER_NUMBER))
    ...
    public void updateOwner() throws Exception {
        ...
        assertThat(testOwner.getCommandCenterNumber()).isEqualTo(UPDATED_COMMAND_CENTER_NUMBER);
        assertThat(testOwner.getEmail()).isEqualTo(UPDATED_EMAIL);
        assertThat(testOwner.getMetadata()).isEqualTo(UPDATED_METADATA);
    }
