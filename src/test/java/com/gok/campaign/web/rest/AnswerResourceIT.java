...
public class AnswerResourceIT {
    ...
    private static final Long DEFAULT_QID = 1L;
    private static final Long UPDATED_QID = 2L;
    ...
    public void getAllAnswers() throws Exception {
        ...
        restAnswerMockMvc.perform(get("/api/answers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].qid").value(hasItem(DEFAULT_QID.intValue())))
    ...
    public void getAnswer() throws Exception {
        ...
        restAnswerMockMvc.perform(get("/api/answers/{id}", answer.getId()))
            ...
            .andExpect(jsonPath("$.qid").value(DEFAULT_QID.intValue()))
